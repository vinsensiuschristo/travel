                ...
                <div class="d-flex justify-content-center">
                    ...
                    <div class="info-block col-lg-4 col-md-12 col-sm-12">
                        <div class="inner-box">
                            ...
                            <h5>Indonesia</h5>
                            <div class="address text">Komp. Villa Mutiara Lido Blok D3 No 6<br>Cigombong, Bogor</div>
                            <div class="phone"><a aria-label="Chat on WhatsApp" href="https://wa.me/+6285282409835?text=Saya%Ingin%Bertanya%Perihal" target="_blank" rel="noopener noreferrer"><img alt="Chat on WhatsApp" src="{{ asset('images/resource/ChatOnWhatsAppButton/WhiteTheme/WhatsAppButtonWhiteMedium.svg') }}" />
                                <a /></a></div>
                        </div>
                    </div>
                </div>
