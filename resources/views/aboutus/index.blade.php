                ...
                <div class="main-box clearfix">
                    ...
                    <div class="nav-box clearfix">
                        ...
                        <div class="nav-outer clearfix">         
                            <nav class="main-menu">
                                <ul class="navigation clearfix">
                                    ...
                                    <li class="current"><a href="{{ route('menu.about-us') }}">About Us</a>
                                    </li>
                        ...
                        <div class="nav-toggler">
                            <button title="menu-icon" lass="hidden-bar-opener"><span class="icon"><img src="images/icons/menu-icon.svg" alt=""></span></button>
                        </div>
                    ...
                    <div class="prod-inner">
                        ...
                        <div class="quantity-box">
                            <div class="item-quantity">
                                <input title="qty" type="text" value="1" name="quantity">
                            </div>
                        </div>
            ...
            <div class="row clearfix">
                ...
                <div class="text-col col-lg-6 col-md-12 col-sm-12">
                    <div class="inner wow fadeInRight" data-wow-duration="1500ms" data-wow-delay="0ms">
                        <h2>Inovation Tour</h2>
                        <div class="text upper-text">
                            <p>Inovation Tour didirikan pada tahun 2024 oleh para pecinta traveling yang ingin membawa pengalaman wisata yang lebih seru dan berbeda bagi para wisatawan, khususnya anak muda. Kami bosan dengan paket wisata yang monoton dan membosankan. Di Inovation Tour, kami ingin Anda merasakan petualangan yang tak terlupakan dengan berbagai pilihan wisata yang unik dan seru</p>
                            <p>Tim kami terdiri dari para traveler berpengalaman dan berdedikasi yang selalu siap membantu Anda merencanakan perjalanan yang sesuai dengan keinginan dan budget Anda. Kami menawarkan berbagai macam paket wisata, mulai dari wisata alam yang indah, wisata budaya yang menarik, hingga wisata kuliner yang menggoda selera.</p>
                            <p>Di Inovation Tour, kami tidak hanya ingin membawa Anda ke tempat-tempat wisata yang indah, tetapi juga ingin membantu Anda untuk menciptakan kenangan indah bersama orang-orang tercinta. Kami percaya bahwa traveling adalah tentang pengalaman, dan kami ingin Anda mengalami yang terbaik bersama Inovation Tour.</p>
                        </div>
                    </div>
                </div>
                <!--Image Col-->
    ...
    <section class="why-section">
        ...
        <div class="auto-container">
            ...
            <div class="title-box centered">
                <h2><span>Kenapa Inovation Tour</span></h2>
            </div>
                ...
                <div class="left-col col-xl-3 col-lg-4 col-md-6 col-sm-12">
                    <div class="inner">
                        ...
                        <div class="why-block">
                            ...
                            <div class="text">Ingin foto Instagramable yang kece? Kami punya destinasi dengan view yang bikin kamu pangling!</div>
                            </div>
                        </div>
                    </div>
                </div>
