                            ...
                            <nav class="main-menu">
                                <ul class="navigation clearfix">
                                    ...
                                    <li class="dropdown"><a href="#">Destinations</a>
                                        <ul>
                                            <li class="current"><a href="{{ route('menu.inter-destination') }}">International Destination</a></li>
    ...
    <section class="hidden-bar">
        ...
        <div class="hidden-bar-wrapper">
            ...
            <div class="nav-logo-box">
                <div class="logo"><a href="{{ route('menu.index') }}" title="Treker"><img src="images/new-icon.png" alt="" title="Treker"></a></div>
            </div>
            <!-- .Side-menu -->
            <div class="side-menu">
                <ul class="navigation clearfix">
                    <li><a href="{{ route('menu.index') }}">Home</a></li>
                    <li><a href="{{ route('menu.about-us') }}">About Us</a></li>
                    <li class="current" class="dropdown"><a href="#">Destinations</a>
                        <ul>
                            <li class="current"><a href="{{ route('menu.inter-destination') }}">International Destination</a></li>
                            <li><a href="{{ route('menu.local-destination') }}">Local Destination</a></li>
                        </ul>
